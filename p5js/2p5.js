...
function draw(){
    ...
    fill("#893229");
    strokeWeight(3);
    circle(width/2,y,150); //balloon 150

    stroke("black");
    strokeWeight(1);
    fill("black");
    line(340,y+74,340,y+150); //line 224
    line(360,y+75,340,y+150) //line cross 225
    line(340,y+74,360,y+150); //line cross 224
    arc(350, y+150, 20, 30, 0, PI); //bottom of balloon 300
    line(360,y+75,360,y+240); //line 225
    //make the balloon move between y = 50 and y = 200
    if(y>200){
        direction = true;
    } else if (y<=50){
        direction = false;
    }
    if(y>=50 && direction == false){
        y++;
